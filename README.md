...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/lingering-mode-bd9e
```

A live public deployment of this template is available at [https://lingering-mode-bd9e.templates.workers.dev](https://lingering-mode-bd9e.templates.workers.dev)
